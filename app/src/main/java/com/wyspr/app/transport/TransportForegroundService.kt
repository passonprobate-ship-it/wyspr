...
/**
 * Foreground service that keeps Wyspr's transport stack alive
 ...
 * icon is the monochrome wyspr-arch glyph. Tapping the body
...
class TransportForegroundService : Service() {
    ...
    private fun ensureChannel() {
        ...
        nm.createNotificationChannel(
            NotificationChannel(
                ...
                description = "Shown while Wyspr is keeping a Bluetooth or " +
    ...
    private fun buildNotification(reason: Reason): Notification {
        ...
        val (title, body) = when (reason) {
            Reason.Handshake -> "Wyspr" to "Pairing in progress"
            Reason.Sharing -> "Wyspr" to "Sharing app with a peer"
            Reason.Transport -> "Wyspr" to "Connection active"
            Reason.WalletSync -> "Wyspr" to "Wallet syncing in background"
        }
    ...
    companion object {
        private const val ACTION_START = "com.wyspr.transport.START"
        private const val ACTION_STOP = "com.wyspr.transport.STOP"
        private const val ACTION_STOP_ALL = "com.wyspr.transport.STOP_ALL"
