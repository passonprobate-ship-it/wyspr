package com.keystone.core.identity

/**
 * A Keystone identity. The private key never leaves the hardware keystore;
 ...
 *
 * First 16 bytes of SHA-256(pub || "KEYSTONE-FP"), rendered as five
...
value class Fingerprint private constructor(val text: String) {
    ...
    companion object {
        private const val DOMAIN = "KEYSTONE-FP"
