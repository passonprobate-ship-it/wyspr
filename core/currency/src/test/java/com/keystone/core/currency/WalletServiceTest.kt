...
/**
 * Unit tests with in-memory fakes for KeystoneDatabase + DAOs +
...
class WalletServiceTest {
    ...
    private class FakeDatabase : KeystoneDatabase {
        ...
        override val communityMembershipDao: com.keystone.core.database.dao.CommunityMembershipDao =
            object : com.keystone.core.database.dao.CommunityMembershipDao {
                override suspend fun upsert(row: com.keystone.core.database.entities.CommunityMembershipEntity) =
                    throw NotImplementedError()
                override suspend fun firstOrNull(): com.keystone.core.database.entities.CommunityMembershipEntity? =
                    throw NotImplementedError()
                override suspend fun all(): List<com.keystone.core.database.entities.CommunityMembershipEntity> =
                    throw NotImplementedError()
                override suspend fun count(): Int = throw NotImplementedError()
