 ...
 * rest. Pattern matches `WYSPR/v1/db` (SQLCipher key) and
 * `WYSPR/v1/tor-hs` (Tor HSv3 key) — the wallet's spend and
...
class MoneroKeyStore @Inject constructor(
    ...
    /**
     * Derive the 32-byte symmetric key Wyspr uses to wrap
     ...
     *
     * The subkey label `WYSPR/v1/monero` is intentionally
    ...
    companion object {
        private val SUBKEY_LABEL = "WYSPR/v1/monero".encodeToByteArray()
