...
import com.wyspr.feature.monero.AddressValidator
...
private fun AddressBookPanel(
    rows: List<com.wyspr.core.database.entities.AddressBookEntity>,
    onPick: (com.wyspr.core.database.entities.AddressBookEntity) -> Unit,
    onDelete: (com.wyspr.core.database.entities.AddressBookEntity) -> Unit,
) {
