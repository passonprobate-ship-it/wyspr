...
private fun WhyMoneroPanel() {
    KeystonePanel(modifier = Modifier.fillMaxWidth()) {
        Column(verticalArrangement = Arrangement.spacedBy(6.dp)) {
            ...
            Bullet(
                "Light on mobile. " +
                    "Keystone uses mollyim's monero-wallet-sdk — it talks to a remote node " +
...
private fun WhatYouGetPanel() {
    KeystonePanel(modifier = Modifier.fillMaxWidth()) {
        Column(verticalArrangement = Arrangement.spacedBy(6.dp)) {
            ...
            Row("Your IP", "Keystone routes every byte of wallet traffic through its " +
        ...
        Column(verticalArrangement = Arrangement.spacedBy(6.dp)) {
            ...
            Text(
                text = "Strong cryptography doesn't help if you announce \"I just acquired " +
                    ...
                    "your seed words. Keystone preserves what it can; the rest is on you.",
