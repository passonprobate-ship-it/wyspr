...
/**
 * Default list of Monero remote nodes Keystone will round-robin
 * across. Curated for the v0.7.0 scaffold; users will be able to
 * add their own nodes (or run a private node on a Keystone Pi) in
 * a later sprint.
 *
 ...
 *
 * All inclusion checks done manually — Keystone never auto-imports
...
internal object MoneroNodeRegistry {
     ...
     * end-to-end probed from Keystone yet** — see kdoc above.
     */
