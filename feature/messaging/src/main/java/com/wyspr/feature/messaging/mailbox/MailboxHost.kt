 ...
 * sweep). Phase 3 will wire them into [com.wyspr.feature.messaging.sync.MessageSyncService]
...
class MailboxHost @Inject constructor(
    ...
    private suspend fun isInCommunity(peerPub: PublicKey): Boolean {
        ...
        if (level == com.wyspr.core.trust.TrustLevel.Unknown ||
            level == com.wyspr.core.trust.TrustLevel.Quarantined
        ) {
            return false
        }
