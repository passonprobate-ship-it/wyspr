package com.wyspr.feature.messaging.mailbox.screens
...
import com.wyspr.feature.messaging.mailbox.MailboxQr
import com.wyspr.feature.messaging.mailbox.MailboxQrCodec
        ...
        if (!hasPermission) {
            ...
            CameraPreview(onPayload = { text ->
                ...
                if (qr == null) {
                    ...
                    onInvalidRef("That QR isn't a Wyspr mailbox code.")
