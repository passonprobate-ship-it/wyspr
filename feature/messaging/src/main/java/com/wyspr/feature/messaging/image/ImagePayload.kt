 ...
 * carried inside the existing [com.wyspr.feature.messaging.MessageEnvelope.body]
 * + [com.wyspr.feature.messaging.groups.GroupMessageEnvelope.body]
 * string field. Same shape as [com.wyspr.feature.messaging.location.LocationPayload],
 * different prefix.
 *
 * Wire shape (in the body string):
 *
 *     wyspr:img:{base64-of-jpeg-bytes}
 *
