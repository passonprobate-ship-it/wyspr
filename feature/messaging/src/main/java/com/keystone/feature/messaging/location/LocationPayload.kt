package com.keystone.feature.messaging.location
 ...
 *
 *     keystone:loc:{lat},{lng},{accuracy_meters}
 *
 ...
 *
 * The `keystone:` prefix doubles as a magic marker: receivers
 ...
 * scheme: `keystone:{kind}:{...}`. When we eventually promote this
...
object LocationPayload {
    private const val PREFIX = "keystone:loc:"
