 ...
 * meet someone in person who doesn't yet have Wyspr installed; the
 ...
 *   GET /wyspr.apk     → APK bytes (Content-Disposition: attachment)
...
internal class ApkShareServer(
    ...
    private fun apkResponse(): Response {
        ...
        response.addHeader(
            "Content-Disposition",
            "attachment; filename=\"wyspr-$versionName.apk\"",
        )
