...
import com.wyspr.feature.onboarding.DiscoveryViewModel
...
fun DiscoveryScreen(
    ...
    Column(
        ...
        Text(
            "Scans for other Wyspr devices in range that advertise the " +
...
private fun PermissionPrompt(missing: List<String>, onRequest: () -> Unit) {
    Card(modifier = Modifier.fillMaxWidth()) {
        Column(
            ...
            Text(
                "Wyspr scans and advertises over Bluetooth Low Energy. " +
