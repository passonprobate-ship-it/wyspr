...
import com.wyspr.feature.onboarding.OnboardingViewModel
...
fun RolePickerScreen(
    ...
    Column(
        ...
        RoleCard(
            ...
            description = "Set up Wyspr for the first time, then invite people you " +
        ...
        RoleCard(
            ...
            description = "Someone you trust is already in Wyspr and is sitting " +
...
private fun WysprMark() {
    ...
    Canvas(modifier = Modifier.size(80.dp)) {
        ...
        drawCircle(
            color = WysprAccent.Verified.copy(alpha = 0.25f),
            radius = outer,
            style = Stroke(width = 1.5f),
        )
        drawCircle(
            color = WysprAccent.Verified.copy(alpha = 0.6f),
            radius = outer * 0.72f,
            style = Stroke(width = 1.5f),
        )
