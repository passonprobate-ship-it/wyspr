 ...
 *
 * Styling mirrors Wyspr's design tokens (dark surface, monospace
...
<body>
  ...
  <h1>You've been invited to Wyspr</h1>
  <p>
  ...
  <h2>What Wyspr is</h2>
  <p>
    Wyspr is a private, peer-to-peer app for small trusted
  ...
  <p class="warn">
    ...
    That's expected — Wyspr is not on the Play Store. Allow the
    download, then allow installation when prompted.
  </p>

  <a class="button" href="/wyspr.apk">I agree — download Wyspr</a>
