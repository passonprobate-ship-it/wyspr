 ...
 * ## Certificate shape
 *
 *   - Subject + Issuer: `CN=Keystone Share (<ip>)`
...
internal object SelfSignedCert {
    ...
    private fun generateCertificate(keyPair: KeyPair, ip: String): X509Certificate {
        ...
        val subject = X500Name("CN=Keystone Share ($ip)")
    ...
    private const val ALIAS = "keystone-share"
    /**
     ...
     */
    private val KEYSTORE_PASSWORD = "keystone-share-ephemeral".toCharArray()
